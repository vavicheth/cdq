...
class DepartmentsController extends Controller
{
    ...
    public function show($id)
    {
        ...
        $staff = \App\Staff::where('department_code_id', $id)->get();

        $department = Department::findOrFail($id);

        return view('admin.departments.show', compact('department', 'staff'));
    }
    ...
    public function getBed($id)
    {
        ...
        $d=Department::where('id','=',$id)->get();
        $userData['data'] = $d->pluck('beds')->first();
