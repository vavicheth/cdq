        ...
        <div class="panel-body">
            <div class="row">
                <div class="col-xs-12 form-group">
                    ...
                    {!! Form::text('name', old('name'), ['class' => 'form-control', 'placeholder' => 'Department name']) !!}
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    ...
                    {!! Form::number('beds', old('beds'), ['class' => 'form-control', 'placeholder' => '']) !!}
                    <p class="help-block"></p>
                    @if($errors->has('beds'))
                        <p class="help-block">
                            {{ $errors->first('beds') }}
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    {!! Form::label('order', trans('quickadmin.departments.fields.order').'', ['class' => 'control-label']) !!}
                    {!! Form::number('order', old('description'), ['class' => 'form-control', 'placeholder' => '']) !!}
                    <p class="help-block"></p>
                    @if($errors->has('order'))
                        <p class="help-block">
                            {{ $errors->first('order') }}
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    ...
                    {!! Form::checkbox('active', 1, old('active', false), []) !!}
                    <p class="help-block"></p>
